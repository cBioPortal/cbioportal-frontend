# cbioportal-frontend
This is the frontend code for cBioPortal which uses React, MobX and TypeScript. Read about the architecture of cBioPortal [here](https://docs.cbioportal.org/2.1-deployment/architecture-overview).
