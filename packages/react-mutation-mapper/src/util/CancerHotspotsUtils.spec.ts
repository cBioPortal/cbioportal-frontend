...
describe('CancerHotspotsUtils', () => {
    ...
    describe("isHotspot", () => {
        it("isHotspot works correctly", ()=>{
            assert.isFalse(isHotspot({gene:{chromosome:"1"}, startPosition:2, endPosition:2, referenceAllele:"A", variantAllele:"T"} as any, hotspotIndex));
            assert.isTrue(isHotspot({gene:{chromosome:"4"}, startPosition:111, endPosition:111, referenceAllele:"T", variantAllele:"C"} as any, hotspotIndex));
            assert.isFalse(isHotspot({gene:{chromosome:"asdkfjpaosid"}, startPosition:-1, endPosition:-1, referenceAllele:"A", variantAllele:"T"} as any, hotspotIndex));
        });
    });
    ...
    describe("groupHotspots", () => {
        const mutationsByPosition = {
            [1]: [{gene:{chromosome:"17"}, startPosition:66, endPosition:66, referenceAllele:"A", variantAllele:"T"}] as any[],
            [2]: [{gene:{chromosome:"3"}, startPosition:666, endPosition:668, referenceAllele:"G", variantAllele:"CAT"},
                {gene:{chromosome:"4"}, startPosition:111, endPosition:111, referenceAllele:"T", variantAllele:"C"},
                {gene:{chromosome:"NA"}, startPosition:-1, endPosition:-1, referenceAllele:"A", variantAllele:"T"}] as any[],
            [4]: [{gene:{chromosome:"1"}, startPosition:2, endPosition:2, referenceAllele:"A", variantAllele:"T"}] as any[],
        };
