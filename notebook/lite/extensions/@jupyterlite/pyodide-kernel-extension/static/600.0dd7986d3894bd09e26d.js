/*! For license information please see 600.0dd7986d3894bd09e26d.js.LICENSE.txt */
'use strict';
(self.webpackChunk_jupyterlite_pyodide_kernel_extension =
    ...
    [600],
    {
        952: (e, t, n) => {
            ...
            var i = n.t(s);
            const o = n.p + 'pypi/piplite-0.2.3-py3-none-any.whl';
            var l = n.t(o);
            const c = n.p + 'pypi/pyodide_kernel-0.2.3-py3-none-any.whl';
            var p = n.t(c);
            ...
            function R(e, t = globalThis, n = ['*']) {
                t.addEventListener('message', function r(a) {
                    ...
                    const { id: s, type: i, path: o } = Object.assign(
                            { path: [] },
                            a.data
                        ),
                    ...
                    Promise.resolve(c)
                        ...
                        .then(n => {
                            const [a, o] = K(n);
                            t.postMessage(
                                Object.assign(Object.assign({}, a), { id: s }),
                                o
                            ),
                                'RELEASE' === i &&
            ...
            class H extends b.BaseKernel {
                ...
                initWorker(e) {
                    return new Worker(new URL(n.p + n.u(576), n.b), {
                        type: void 0,
                    });
                }
                async initRemote(e) {
...
//# sourceMappingURL=600.0dd7986d3894bd09e26d.js.map?v=0dd7986d3894bd09e26d
