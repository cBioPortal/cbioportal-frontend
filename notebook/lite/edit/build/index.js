...
export async function main() {
    ...
    if (
        !federatedExtensionNames.has('@jupyter-notebook/application-extension')
    ) {
        try {
    ...
    if (
        !federatedExtensionNames.has('@jupyter-notebook/docmanager-extension')
    ) {
        try {
