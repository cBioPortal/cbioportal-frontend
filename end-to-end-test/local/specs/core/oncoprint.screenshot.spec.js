...
describe('oncoprint', function() {
    ...
    describe('clinical tracks', () => {
        ...
        it('updates url when changing gaps', async () => {
            await changeNthTrack(1, "Don't show gaps");
         ...
         */
        it('stores config in user session when save button clicked', async () => {
         ...
         */
        it('uses configuration stored in session when available', async () => {
