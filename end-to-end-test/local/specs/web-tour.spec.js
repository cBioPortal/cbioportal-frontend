...
describe('Virtual Study Tour', () => {
    ...
    it('Step 1: User should select two studies, on the homepage', () => {
        ...
        // Select two study
        cancerStudyList.$$('input')[0].waitForDisplayed();
        cancerStudyList.$$('input')[0].click();
        cancerStudyList.$$('input')[1].click();
    ...
    it('Step 6: Click the bookmark icon, on the study summary page.', () => {
        ...
        $('[data-tour="action-button-bookmark"]').click();
        browser.pause(1000);
        step++;
    });
    ...
    it('Step 7: Click on the Save button, on the study summary page.', () => {
        ...
        // There should be a share button [data-tour="virtual-study-summary-share-btn"]
        // Click the share button, the tour should go to the next step
        sharePanel.$('[data-tour="virtual-study-summary-share-btn"]').click();
        browser.pause(1000);
        step++;
    });
