...
describe('Results Page', function() {
    ...
    describe('Mutations Tab', () => {
        ...
        describe('Lollipop Plot Tracks', () => {
            ...
            it('shows tracks when the corresponding dropdown menu options selected', () => {
                ...
                // open PTM track
                browser
                    .elements('.//*[text()[contains(.,"Post Translational Modifications")]]')
                    .value[0].click();
    ...
    describe('oql status banner', function() {
        ...
        it('should not be present in cancer types summary with simple query', function() {
            ...
            browser.pause(500);
            assert(
                !browser.isVisible(`${yesBannerSelector}.cancer-types-summary-oql-status-banner`)
            );
            assert(
                !browser.isVisible(`${noBannerSelector}.cancer-types-summary-oql-status-banner`)
            );
        });
        ...
        it('should not be present in enrichments tab with simple query', function() {
            ...
            browser.waitForVisible('.comparisonTabSubTabs .tabAnchor_mutations');
            browser.click('.comparisonTabSubTabs .tabAnchor_mutations');
            browser.pause(500);
            assert(!browser.isVisible(`${yesBannerSelector}.comparison-oql-status-banner`));
            assert(!browser.isVisible(`${noBannerSelector}.comparison-oql-status-banner`));
        });
        ...
        it('should be present in enrichments tab with explicit query', function() {
            ...
            browser.waitForVisible('.comparisonTabSubTabs .tabAnchor_mutations');
            browser.click('.comparisonTabSubTabs .tabAnchor_mutations');
            browser.waitForVisible(`${yesBannerSelector}.comparison-oql-status-banner`, 10000);
            assert(browser.isVisible(`${yesBannerSelector}.comparison-oql-status-banner`));
            assert(!browser.isVisible(`${noBannerSelector}.comparison-oql-status-banner`));
        });
