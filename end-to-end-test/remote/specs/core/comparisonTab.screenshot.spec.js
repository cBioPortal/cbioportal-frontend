...
describe('results view comparison tab screenshot tests', function() {
    describe('general screenshot tests', function() {
        ...
        it.omit(
            'results view comparison tab mutation enrichments tab several groups',
            function() {
                goToUrlAndSetLocalStorage(
        ...
        it.omit(
            'results view comparison tab mutation enrichments tab patient mode',
            function() {
                browser.execute(function() {
        ...
        it.omit(
            'results view comparison tab mutation enrichments tab 20 genes with highest frequency in any group',
            function() {
                browser.execute(function() {
        ...
        it.omit(
            'results view comparison tab mutation enrichments tab gene box highest average frequency',
            function() {
                browser.click('[data-test="selectGenes"]');
                browser.execute(function() {
        ...
        it.omit(
            'results view comparison tab mutation enrichments tab gene box most significant pValues',
            function() {
                browser.click('[data-test="selectGenes"]');
                browser.execute(function() {
                    genesSelection.onGeneListOptionChange({
        ...
        it.omit(
            'results view comparison tab mutation enrichments tab gene box user-defined genes',
            function() {
                browser.click('[data-test="selectGenes"]');
                setInputText(
        ...
        it.omit(
            'results view comparison tab mrna enrichments tab several groups',
            function() {
        ...
        it.omit(
            'results view comparison tab mutation enrichments tab two groups',
            function() {
                goToUrlAndSetLocalStorage(
