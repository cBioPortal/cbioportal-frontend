...
describe('Patient View Genomic Evolution tab', function() {
    describe("mutation table", ()=>{
        before(()=>{
            goToUrlAndSetLocalStorage(`${CBIOPORTAL_URL}/patient/genomicEvolution?caseId=P04&studyId=lgg_ucsf_2014`);
        ...
        it("shows only highlighted, or all mutations, depending on setting", ()=>{
            ...
            browser.waitForExist('div[data-test="GenomicEvolutionMutationTable"] span[data-test="LazyMobXTable_CountHeader"]');
            let numMutationsText = browser.getText('div[data-test="GenomicEvolutionMutationTable"] span[data-test="LazyMobXTable_CountHeader"]');
            ...
            browser.click('div[data-test="GenomicEvolutionMutationTable"] table tbody > tr:nth-child(4)');

            // should still show all
            browser.waitForExist('div[data-test="GenomicEvolutionMutationTable"] span[data-test="LazyMobXTable_CountHeader"]');
            numMutationsText = browser.getText('div[data-test="GenomicEvolutionMutationTable"] span[data-test="LazyMobXTable_CountHeader"]');
            ...
            }, 2000, "should only be 2 mutations in the table now");
            ...
            }, 2000, "should only be 1 mutation in the table now");
            ...
            browser.waitUntil(()=>{
                ...
                numMutations = parseInt(numMutationsText, 10);
                return numMutations > 2;
            }, 2000, "should show all mutations again, since none explicitly selected");
        });
    });
});