...
describe('Patient View Genomic Evolution tab screenshot tests', function() {
    ...
    it('pvge initial view with line chart', async function() {
    ...
    it('pvge show timeline', async function() {
    ...
    it('pvge one mutation selected with line chart', async function() {
    ...
    it.skip('pvge hover a mutation with line chart', async function() {
        jsApiHover(
    ...
    it('pvge heatmap with two mutations selected from before', async function() {
    ...
    it('pvge one mutation selected with heatmap', async function() {
        $(
            'div[data-test="GenomicEvolutionMutationTable"] table tbody > tr:nth-child(1)'
        ).click();
    ...
    it('pvge hover a mutation with heatmap', async function() {
        $(
    ...
    it('pvge uncluster heatmap', async function() {
    ...
    it('pvge transpose heatmap', async function() {
    ...
    it('pvge transposed heatmap hide labels', async function() {
    ...
    it('pvge heatmap hide labels', async function() {
        $('input[data-test="HeatmapTranspose"]').click();
