...
describe('oncoprint screenshot tests', function() {
    it('ov_tcga_pub with germline mutations', async function() {
    ...
    it('coadread_tcga_pub with clinical and heatmap tracks', async function() {
    ...
    it('acc_tcga with clinical and heatmap tracks', async function() {
    ...
    it('blca_tcga with clinical and heatmap tracks', async function() {
    ...
    it('hcc_inserm_fr_2015 with genes including TERT - it should show orange promoter mutations in TERT', async function() {
        goToUrlAndSetLocalStorage(
    ...
    it('msk_impact_2017 with SOS1 - SOS1 should be not sequenced', async function() {
    ...
    it('msk_impact_2017 with ALK and SOS1 - SOS1 should be not sequenced', async function() {
    ...
    it('msk_impact_2017 with SOS1 with CNA profile - SOS1 should not be sequenced', async function() {
    ...
    it('brca_tcga_pub with KRAS NRAS BRAF and methylation heatmap tracks', async function() {
    ...
    it('profiled in tracks in msk impact with 3 not profiled genes', async function() {
    ...
    it('profiled in tracks in a combined study', async function() {
        goToUrlAndSetLocalStorage(
    ...
    it('profiled in tracks in multiple study with SOS1', async function() {
    ...
    it('multiple tracks with same gene', async function() {
        goToUrlAndSetLocalStorage(
    ...
    it('removes top treatment track successfully', async function() {
        goToUrlAndSetLocalStorage(
    ...
    it('coadread_tcga_pub with column gaps inserted based on clinical track', async function() {
        goToUrlAndSetLocalStorage(
...
describe('track group headers', function() {
    ...
    it('oncoprint should cluster heatmap group correctly', async function() {
        var res = checkOncoprintElement();
        assertScreenShotMatch(res);
    });

    it.skip('oncoprint should delete clustered heatmap group correctly', async function() {
    ...
    it('oncoprint should delete non-clustered heatmap group correctly', async function() {
    ...
    it.skip('oncoprint should return to non-clustered state correctly', async function() {
        // Cluster the mrna heatmap group
        var mrnaElements = getGroupHeaderOptionsElements(2);
        setDropdownOpen(
            true,
...
describe('sorting', function() {
    it('oncoprint should sort patients correctly in coadread_tcga_pub', async function() {
    ...
    it('oncoprint should sort samples correctly in coadread_tcga_pub', async function() {
        setDropdownOpen(
            true,
    ...
    it('oncoprint should sort patients correctly in gbm_tcga_pub', async function() {
        goToUrlAndSetLocalStorage(CBIOPORTAL_URL);
    ...
    it('oncoprint should sort samples correctly in gbm_tcga_pub', async function() {
        setDropdownOpen(
            true,
            '.oncoprintContainer .oncoprint__controls #viewDropdownButton',
            '.oncoprintContainer .oncoprint__controls input[type="radio"][name="columnType"][value="0"]'
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - initial patient order', async function() {
        goToUrlAndSetLocalStorage(
            CBIOPORTAL_URL +
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - initial sample order', async function() {
        setDropdownOpen(
            true,
            '.oncoprintContainer .oncoprint__controls #viewDropdownButton',
            '.oncoprintContainer .oncoprint__controls input[type="radio"][name="columnType"][value="0"]'
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - sorted patient order 1', async function() {
        setDropdownOpen(
            true,
            '.oncoprintContainer .oncoprint__controls #viewDropdownButton',
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - sorted patient order 2', async function() {
        var overallSurvivalElements = getNthTrackOptionsElements(4);
        setDropdownOpen(
            true,
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - sorted patient order 3', async function() {
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - sorted patient order 4', async function() {
        var karnofskyPerformanceElements = getNthTrackOptionsElements(3);
        setDropdownOpen(
            true,
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - sorted sample order 1', async function() {
        setDropdownOpen(
            true,
            '.oncoprintContainer .oncoprint__controls #viewDropdownButton',
            '.oncoprintContainer .oncoprint__controls input[type="radio"][name="columnType"][value="0"]'
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - sorted sample order 2', async function() {
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - sorted sample order 3', async function() {
        var diseaseFreeElements = getNthTrackOptionsElements(2);
        setDropdownOpen(
            true,
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - sorted sample order 4', async function() {
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - sorted sample order 5', async function() {
        var fractionGenomeAlteredElements = getNthTrackOptionsElements(1);
        setDropdownOpen(
            true,
    ...
    it('oncoprint sorts through a flow with clinical tracks sorted - sorted sample order 6', async function() {
    ...
    it('oncoprint sorts through a flow with heatmap tracks sorted - sorted sample order 1', async function() {
        goToUrlAndSetLocalStorage(
            CBIOPORTAL_URL +
    ...
    it('oncoprint sorts through a flow with heatmap tracks sorted - sorted sample order 2', async function() {
        var TP53HeatmapElements = getNthTrackOptionsElements(8);
        setDropdownOpen(
            true,
    ...
    it('oncoprint sorts through a flow with heatmap tracks sorted - sorted sample order 3', async function() {
        var TP53HeatmapElements = getNthTrackOptionsElements(8);
        setDropdownOpen(
            false,
            TP53HeatmapElements.button_selector,
    ...
    it('oncoprint sorts through a flow with heatmap tracks sorted - sorted sample order 4', async function() {
        var MDM4HeatmapElements = getNthTrackOptionsElements(13);
        setDropdownOpen(
            true,
    ...
    it('oncoprint sorts through a flow with heatmap tracks sorted - sorted sample order 5', async function() {
        var TP53HeatmapElements = getNthTrackOptionsElements(8);
    ...
    it('oncoprint sorts through a flow with heatmap tracks sorted - sorted patient order 1', async function() {
        setDropdownOpen(
            true,
            '.oncoprintContainer .oncoprint__controls #viewDropdownButton',
            '.oncoprintContainer .oncoprint__controls input[type="radio"][name="columnType"][value="1"]'
