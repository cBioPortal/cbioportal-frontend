...
export const FEATURE_FLAG_METADATA: {
    ...
    [FeatureFlagEnum.ONCOTREE2GENES]: {
        title: 'OncoTree2Genes Gene Filter',
        category: 'Study View',
        description:
            'Filters and annotates genes in Study View using the ' +
            'OncoTree2Genes-LLM dataset, which associates genes with cancer ' +
            'types via OncoTree diagnosis codes.',
        userOptIn: true,
        exampleUrl: '/oncotree2genes',
    },
};
