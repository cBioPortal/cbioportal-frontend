            ...
            <span className={classnames(styles.downloadTabLinksGroup, this.props.className)}>
                {
                    ...
                    <a onClick={this.props.handleCopy} ref={this.props.copyLinkRef}>
                        <i className='fa fa-clipboard'/>{this.props.copyLabel}
                    </a>
                }
                {
                ...
                }
                {
                    ...
                    <a onClick={this.props.handleDownload}>
                        <i className='fa fa-cloud-download'/>{this.props.downloadLabel}
                    </a>
                }
                {
                ...
                }
                {
                    ...
                    <a onClick={this.props.handleQuery}>
                        <i className='fa fa-external-link-square'/>{this.props.queryButtonLabel}
                    </a>
                }
                {
                ...
                }
                {
                    ...
                    <DefaultTooltip
                        ...
                        overlay={
                            this.props.virtualStudyParams && <VirtualStudy
                                ...
                                studyWithSamples={this.props.virtualStudyParams.studyWithSamples}
                                selectedSamples={this.props.virtualStudyParams.selectedSamples}
                                filter={this.props.virtualStudyParams.filter}
                                attributesMetaSet={this.props.virtualStudyParams.attributesMetaSet}
                            />
                        }
                        placement="bottom"
                    >
                        <a>
                            <i className='fa fa-pie-chart'/>{this.props.virtualStudyButtonLabel}
                        </a>
                    </DefaultTooltip>
                }
                {
