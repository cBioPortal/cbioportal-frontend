...
describe('MSKTable', ()=>{
    ...
    describe('headers', ()=>{
        ...
        it("sets initial sort class correctly, and sets and toggles class correctly when clicking on columns", ()=>{
            ...
            assert.isTrue(stringHeader.hasClass("sort-des") && !stringHeader.hasClass("sort-asc"), "string header starts with descending sort, its firstSortDirection");
    ...
    describe('sorting', ()=>{
        ...
        it("sorts rows according to the selected sort column and direction", ()=>{
            ...
            assert.isTrue(header.hasClass("sort-des"), "Number column starts with descending, its firstSortDirection");
            header.simulate('click');
