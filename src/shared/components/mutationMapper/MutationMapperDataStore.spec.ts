...
describe('MutationMapperDataStore', () => {
    ...
    it('toggles selections correctly, selects mutations by position, and gives them in sorted order', () => {
        let store: MutationMapperDataStore = new MutationMapperDataStore(mergedMutations);
        store.setSelectionFilters([{ type: DataFilterType.POSITION, values: [5] }]);
        assert.deepEqual(
            store.sortedFilteredData,
        ...
        store.setSelectionFilters([{ type: DataFilterType.POSITION, values: [5, 10] }]);
        assert.deepEqual(
            store.sortedFilteredData,
            [[pos10Mutation], [pos5Mutation], [pos20Mutation]],
        ...
        store.setSelectionFilters([{ type: DataFilterType.POSITION, values: [5, 10, 20] }]);
        assert.deepEqual(
            store.sortedFilteredData,
            [[pos10Mutation], [pos20Mutation]],
        ...
        store.setSelectionFilters([{ type: DataFilterType.POSITION, values: [20] }]);
        assert.deepEqual(
            store.sortedFilteredSelectedData,
            [[pos20Mutation]],
    ...
    it('implements isPositionSelected', () => {
        ...
        store.setSelectionFilters([{ type: DataFilterType.POSITION, values: [1] }]);
        ...
        store.setSelectionFilters([{ type: DataFilterType.POSITION, values: [1, 3] }]);
        ...
        store.setSelectionFilters([{ type: DataFilterType.POSITION, values: [1, 3, 5] }]);
        ...
        store.setSelectionFilters([{ type: DataFilterType.POSITION, values: [1, 3, 5, 20] }]);
        ...
        store.setSelectionFilters([{ type: DataFilterType.POSITION, values: [1, 5, 20] }]);
