...
describe('SortUtils', () => {
    ...
    describe('stringClinicalComparator', () => {
        ...
        it('should return 0 when both have na', () => {
            assert.equal(
                stringClinicalComparator({ na: true, attr_val: 'a' }, { na: true, attr_val: 'b' }),
                0
            );
            assert.equal(
                stringClinicalComparator(
        ...
        it('should return 2 when first has na and second doesnt', () => {
            assert.equal(
                stringClinicalComparator({ na: true, attr_val: 'a' }, { na: false, attr_val: 'b' }),
                2
            );
            assert.equal(
                stringClinicalComparator(
            ...
            assert.equal(
                stringClinicalComparator({ na: true, attr_val: 'b' }, { na: false, attr_val: 'a' }),
                2
            );
            assert.equal(
                stringClinicalComparator(
        ...
        it('should return -2 when first doesnt have na and second does', () => {
            assert.equal(
                stringClinicalComparator({ na: false, attr_val: 'a' }, { na: true, attr_val: 'b' }),
                -2
            );
            assert.equal(
                stringClinicalComparator(
            ...
            assert.equal(
                stringClinicalComparator({ na: false, attr_val: 'b' }, { na: true, attr_val: 'a' }),
                -2
            );
            assert.equal(
                stringClinicalComparator(
