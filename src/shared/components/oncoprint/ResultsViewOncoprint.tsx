...
export default class ResultsViewOncoprint extends React.Component<IResultsViewOncoprintProps, {}> {
    ...
    constructor(props:IResultsViewOncoprintProps) {
        ...
        this.getPutativeDriverInfo = this.getPutativeDriverInfo.bind(this);
    ...
    public getPutativeDriverInfo(mutation:Mutation) {
        ...
        const hotspots:boolean =
            (this.props.store.mutationAnnotationSettings.hotspots &&
                this.props.store.isHotspot.isComplete &&
                this.props.store.isHotspot.result(mutation));
        const cbioportalCount:boolean = false;
            //(this.props.store.mutationAnnotationSettings.cbioportalCount &&
              //  this.props.store.getCBioportalCount.isComplete &&
        //this.props.store.getCBioportalCount.result(mutation) >= this.props.store.mutationAnnotationSettings.cbioportalCountThreshold);
        const cosmicCount:boolean = false;
            //(this.props.store.mutationAnnotationSettings.cosmicCount &&
             //   this.props.store.getCosmicCount.isComplete &&
        //this.props.store.getCosmicCount.result(mutation) >= this.props.store.mutationAnnotationSettings.cosmicCountThreshold);
        // TODO
        return {
            oncoKb,
            hotspots,
