    ...
    describe('makeGeneticTrackTooltip', () => {
        ...
        describe('genetic alterations', () => {
            ...
            it('single genetic alteration across multiple cases - mrna', () => {
                ...
                assert.equal(tooltipOutput.text().match(/MRNA:/g)!.length, 1);
                assert.equal(
                    tooltipOutput.text().match(/GENE UPREGULATED\xa0\(2\)/g)!
                        .length,
                    1
                );
                ...
                assert.equal(tooltipOutput.text().match(/MRNA:/g)!.length, 1);
                assert.equal(
                    tooltipOutput.text().match(/GENE DOWNREGULATED\xa0\(2\)/g)!
                        .length,
                    1
                );
                ...
                assert.equal(tooltipOutput.text().match(/MRNA:/g)!.length, 1);
                assert.equal(
                    tooltipOutput.text().match(/GENE DOWNREGULATED\xa0\(1\)/g)!
                        .length,
                    1
                );
            });
            it('single genetic alteration across multiple cases - prot', () => {
                ...
                assert.equal(tooltipOutput.text().match(/PROT:/g)!.length, 1);
                assert.equal(
                    tooltipOutput.text().match(/GENE UPREGULATED\xa0\(5\)/g)!
                        .length,
                    1
                );
                ...
                assert.equal(tooltipOutput.text().match(/PROT:/g)!.length, 1);
                assert.equal(
                    tooltipOutput.text().match(/GENE DOWNREGULATED\xa0\(5\)/g)!
                        .length,
                    1
                );
            });
            ...
            it('multiple alterations of same type across multiple cases - mrna', () => {
                ...
                assert.equal(tooltipOutput.text().match(/MRNA:/g)!.length, 1);
                assert.equal(
                    tooltipOutput.text().match(/GENE UPREGULATED\xa0\(4\)/g)!
                        .length,
                    1
                );
                assert.equal(
                ...
                assert.equal(tooltipOutput.text().match(/MRNA:/g)!.length, 1);
                assert.equal(
                    tooltipOutput.text().match(/GENE UPREGULATED\xa0\(6\)/g)!
                        .length,
                    1
                );
                assert.equal(
                    tooltipOutput.text().match(/GENE DOWNREGULATED\xa0\(3\)/g)!
                        .length,
                    1
                );
            });
            it('multiple alterations of same type across multiple cases - protein', () => {
                ...
                assert.equal(tooltipOutput.text().match(/PROT:/g)!.length, 1);
                assert.equal(
                    tooltipOutput.text().match(/GENE UPREGULATED\xa0\(3\)/g)!
                        .length,
                    1
                );
                assert.equal(
                    tooltipOutput.text().match(/GENE DOWNREGULATED\xa0\(6\)/g)!
                        .length,
                    1
                );
                ...
                assert.equal(tooltipOutput.text().match(/PROT:/g)!.length, 1);
                assert.equal(
                    tooltipOutput.text().match(/GENE UPREGULATED\xa0\(1\)/g)!
                        .length,
                    1
                );
                assert.equal(
            ...
            it('multiple alterations of different types across multiple cases', () => {
                ...
                assert.equal(
                    tooltipOutput.text().match(/GENE DOWNREGULATED\xa0\(4\)/g)!
                        .length,
                    2
                ); // (2 for mrna and protein)
            });
