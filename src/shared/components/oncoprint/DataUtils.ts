        ...
        switch (molecularAlterationType) {
            ...
            case "MUTATION_EXTENDED":
                ...
                if (oncoprintMutationType === "fusion") {
                    ...
                    const putativeDriverInfo = getPutativeDriverInfo && getPutativeDriverInfo(event);
                    if (putativeDriverInfo &&
                        (putativeDriverInfo.oncoKb || putativeDriverInfo.hotspots ||
                        putativeDriverInfo.cbioportalCount || putativeDriverInfo.cosmicCount)) {
