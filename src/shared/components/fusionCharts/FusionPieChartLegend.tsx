...
@observer
export default class FusionPieChartLegend extends React.Component<
    IFusionPieChartLegendProps,
    {}
> {
    @computed get data() {
        const fusionGenes = Object.keys(this.props.fusionCounts);
        return fusionGenes.map(name => ({ name }));
    }
    ...
    public render() {
        ...
        const legendHeight =
            fusionGenes.length > 9 ? (fusionGenes.length / 9) * 400 : 400;
