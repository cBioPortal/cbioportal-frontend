...
describe('ExternalTool Component', () => {
    ...
    const testUrlFormat = 'http://example.com?study=${studyName}&-DataLength=${dataLength}';
    ...
    it('copies data to clipboard and calls handleLaunchReady', async () => {
        ...
        expect(handleLaunchReadySpy).toHaveBeenCalledWith({ dataLength: testDataLengthString });
    });    
    ...
    it('formats URL correctly and redirects', () => {
        ...
        const expectedUrl = 'http://example.com?study=Test%20Study&-DataLength=9';
