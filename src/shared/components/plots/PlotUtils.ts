...
import { IPlotSampleData, IThreshold1D, IWaterfallPlotData, IScatterPlotData, IBoxScatterPlotPoint, IThreshold2D, IValue1D, IValue2D } from 'pages/resultsView/plots/PlotsTabUtils';
