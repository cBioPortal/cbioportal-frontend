...
export default class WaterfallPlot<D extends IBaseWaterfallPlotData> extends React.Component<IWaterfallPlotProps<D>, {}> {
    ...
    @computed get limitLabels() {
        ...
        const dataPoints = _.filter(this.waterfallPlotData, (d) => this.resolveStyleOptionType<boolean>(d, this.props.labelVisibility));
                            ...
                            <VictoryScatter
                                style={{
                                    data: {
                                        ...
                                        strokeWidth: waterfallSearchIndicatorAppearance.strokeWidth * SEARCH_LABEL_SIZE_MULTIPLIER,
                                        strokeOpacity: waterfallSearchIndicatorAppearance.strokeOpacity
                                    }
                                }}
                                symbol={waterfallSearchIndicatorAppearance.symbol}
                                size={waterfallSearchIndicatorAppearance.size * SEARCH_LABEL_SIZE_MULTIPLIER}
