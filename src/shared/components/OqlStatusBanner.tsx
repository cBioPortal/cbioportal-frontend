...
@observer
export default class OqlStatusBanner extends React.Component<{store:ResultsViewPageStore, style?:any, tabReflectsOql:boolean}, {}> {
    render() {
        if (this.props.store.queryContainsOql) {
            ...
            return (
                <div data-test={dataTest} className={className} style={Object.assign({}, style, this.props.style || {})}>
