...
if (
    ...
    MESSAGE_DATA = [
        ...
        // BASED ON USERS LOCALSTORAGE
        {
            ...
            content: `Join our new webinar series to learn how to use cBioPortal effectively. Third webinar <strong>Thursday May 14th 11am-12pm EDT</strong>. <a class="btn btn-primary btn-xs" target="_blank" href="https://dfci.zoom.us/webinar/register/7315875611981/WN_An_3l0XYQHCoinWvclUrlw">Click for More Info!</a> or <a class="btn btn-primary btn-xs" href="/tutorials#webinars">View Recorded Webinars</a>`,
