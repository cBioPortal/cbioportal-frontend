    ...
    MESSAGE_DATA = [
        ...
        // BASED ON USERS LOCALSTORAGE
        {
            ...
            content: `<div style="" class="text-center">
                The core cBioPortal team is hiring a software engineer! If you know of a great candidate, please <a href="https://bit.ly/3KZdiHx" style="color:lightblue" target="_blank">send them this job description</a>.&nbsp;
             `,
