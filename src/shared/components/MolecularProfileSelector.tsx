...
export interface IMolecularProfileSelector {
    ...
    molecularProfileIdToProfiledSampleCount:
        ...
        | MobxPromise<{ [molecularProfileId: string]: number }>;
}
...
> {
    ...
    readonly options = remoteData({
        await: () => {
            ...
            if (
                this.props.molecularProfileIdToProfiledSampleCount instanceof
                MobxPromise
            ) {
        ...
        invoke: () => {
            ...
            if (this.props.molecularProfiles instanceof MobxPromise) {
                ...
                molecularProfiles = this.props
                    .molecularProfiles as MolecularProfile[];
            }
            if (
                this.props.molecularProfileIdToProfiledSampleCount instanceof
                MobxPromise
            ) {
                molecularProfileIdToProfiledSampleCount = this.props
                    .molecularProfileIdToProfiledSampleCount.result!;
            } else {
                molecularProfileIdToProfiledSampleCount = this.props
                    .molecularProfileIdToProfiledSampleCount as {
                    [molecularProfileId: string]: number;
                };
            }
            return Promise.resolve(
                molecularProfiles.map(profile => {
                    const profiledSampleCount =
                        molecularProfileIdToProfiledSampleCount[
                            profile.molecularProfileId
                        ];
                    return {
                        label: `${profile.name} (${profiledSampleCount} sample${
