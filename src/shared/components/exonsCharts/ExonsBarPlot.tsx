...
export default class ExonBarPlot extends React.Component<
    IExonBarPlotProps,
    {}
> {
    renderExonToolTipContent = (exonRange: ExonRangeExt) => {
        return (
            <ul style={{ listStyleType: 'none', padding: 0 }}>
                <li style={{ color: exonRange!.fillColor }}>
                    <strong>{exonRange!.exonId}</strong>
                </li>
                <li>
                    exon: <strong>{exonRange!.rank}</strong>
                </li>
    ...
    renderPfamTooltipContent = (pfam: PfamDomainRangeExt) => {
        return (
            <ul style={{ listStyleType: 'none', padding: 0 }}>
                <li style={{ color: pfam.fillColor }}>
                    <strong>{pfam.pfamDomainId}</strong>
                </li>
                    ...
                    {this.props.store.computedPfams.map(
                        (pfam: PfamDomainRangeExt) => {
                            ...
                            return (
                                <DefaultTooltip
                                    placement="top"
                                    overlay={this.renderPfamTooltipContent(
                                        pfam
                                    )}
                                >
                                    <rect
    ...
    render() {
        const totalWidth =
            this.props.store.computedTotalWidth +
            this.props.store.deltaXPos +
            10;
