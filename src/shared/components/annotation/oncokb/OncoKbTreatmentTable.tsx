...
> {
    ...
    readonly columns = [
        ...
        },
        {
            name: 'Drug(s)',
            headerRender: (data: string) => <span>{data}</span>,
            render: (data: OncoKbTreatment) => <span>{data.treatment}</span>,
        ...
        },
        {
            ...
            render: (data: OncoKbTreatment) => <span>{data.cancerType}</span>,
        ...
        },
        {
            ...
            render: (data: OncoKbTreatment) => {
                return (
                    <If
                        condition={
                            data.abstracts.length > 0 || data.pmids.length > 0
                        }
                    >
                        <DefaultTooltip
