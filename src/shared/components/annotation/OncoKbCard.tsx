...
export default class OncoKbCard extends React.Component<OncoKbCardProps> {
    ...
    public treatmentRow(
        ...
        const treatmentTooltipContent =
            abstracts.length > 0 || pmids.length > 0 || description ? (
                () => (
                    <div
                        style={{
                            maxWidth: '400px',
                                                    ...
                                                    <Then>
                                                        <div className="refs">
                                                            ...
                                                            >
                                                                ...
                                                                {this.pmidList(
                                                                    this.props.mutationEffectCitations.pmids.map(
                                                                        pmid =>
                                                                            Number(
                                                                                pmid
                                                                            )
    ...
    public summaryWithRefs(
        ...
        parts.forEach((part: string) => {
            ...
            if (part.match(regex)) {
                let component: JSX.Element | string = this.refComponent(
                    part,
                    type
                );
