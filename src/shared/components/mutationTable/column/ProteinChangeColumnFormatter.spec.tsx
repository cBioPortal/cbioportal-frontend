...
describe('ProteinChangeColumnFormatter', () => {
    ...
    it('properly extracts sort value from a protein change string value', () => {
        let valA: number | null = ProteinChangeColumnFormatter.extractSortValue(
            a
        );
        let valB: number | null = ProteinChangeColumnFormatter.extractSortValue(
            b
        );
        let valC: number | null = ProteinChangeColumnFormatter.extractSortValue(
            c
        );
        let valD: number | null = ProteinChangeColumnFormatter.extractSortValue(
            d
        );
