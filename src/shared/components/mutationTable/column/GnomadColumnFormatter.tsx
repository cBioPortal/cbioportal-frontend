...
export default class GnomadColumnFormatter {
    ...
    private static getGnomadDataViz(genomeNexusCacheData: GenomeNexusCacheDataType | null) {
        ...
        if (genomeNexusCacheData == null) {
            ...
            return (
                <GnomadFrequency
                    myVariantInfo={genomeNexusCacheData && genomeNexusCacheData.data && genomeNexusCacheData.data.my_variant_info ?
                        genomeNexusCacheData.data.my_variant_info.annotation: undefined}
                    annotation={genomeNexusCacheData && genomeNexusCacheData.data ? genomeNexusCacheData.data: undefined}
                />
            );
        }
