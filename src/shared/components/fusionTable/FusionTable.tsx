...
export const FusionTableColumnLabelProps: FusionTableColumnProps[] = [
    ...
    {
        columnType: FusionTableColumnType.EXTERNAL_ANNOTATION,
        label: 'External Annotation',
        attribute: 'externalAnnotation',
        visible: false,
    },

    {
        columnType: FusionTableColumnType.DRIVER_FILTER,
        label: 'Driver Filter',
        attribute: 'driverFilter',
        visible: false,
    },
    {
        columnType: FusionTableColumnType.DRIVER_FILTER_ANNOTATION,
        label: 'Driver Filter Annotation',
        attribute: 'driverFilterAnn',
        visible: false,
    },
    {
        columnType: FusionTableColumnType.DRIVER_TIERS_FILTER,
        label: 'Driver Tiers Filter',
        attribute: 'driverTiersFilter',
        visible: false,
    },
    {
        columnType: FusionTableColumnType.DRIVER_TIERS_FILTER_ANNOTATION,
        label: 'Driver Tiers Filter Annotation',
        attribute: 'driverTiersFilterAnn',
        visible: false,
    },
];
