        ...
        if (this.props.children && React.Children.count(this.props.children)) {
            ...
            return (
                ...
                >
                    ...
                    <DeferredRender className={ classnames("tab-content", !!this.props.vertical ? 'tabs-left-content': '') } loadingState={<LoadingIndicator isLoading={true} center={true} size={"big"}/>}>
                        {arr}
                    </DeferredRender>
