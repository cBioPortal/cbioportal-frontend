...
export default class BarGraph extends React.Component<IBarGraphProps, {colors: string[]}> {
    ...
    componentDidMount() {
        ...
        const datasets = _.flattenDeep(cancerTypeStudiesArray.map((cancerStudySet, i) => (
            cancerStudySet.studies.sort((a: ICounterObj, b:ICounterObj) => +b.allSampleCount - +a.allSampleCount).map((cancerStudy: CancerStudy, j: number) => {
        ...
        const options = {
            ...
            tooltips: {
                ...
                callbacks: {
                    title: (tooltipItem:ITooltipItem[], _data:any) => {
                    ...
                    label: (tooltipItems:ITooltipItem, _data:any) => {
    ...
    render() {
        return <canvas id="chart" height="500px"/>;
    }
