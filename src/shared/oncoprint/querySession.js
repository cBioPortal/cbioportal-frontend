...
window.geneticrules = geneticRules;

window.cbioportal_client = cbioportal_client;

import OQL from './oql';

const initDatamanager = function (genetic_profile_ids, oql_query, cancer_study_ids, study_sample_map, z_score_threshold, rppa_score_threshold,
                                   case_set_properties) {
