...
describe("ComplexKeyMap", ()=>{
    ...
    it("`has` returns true iff there is a corresponding entry", ()=>{
        ...
        const crazyKey = {"aijsdpfoiaj3141#.131-4-r1":"aisdjfpaosijd#rjrq", "ijzpxdcidajf9w83r!341$$$":19183409180};
    ...
    it("`from` creates a ListIndexedMap from a given list", ()=>{
        ...
        assert.deepEqual(map2.get({"234ijdfapso#":"obj1", whatever:"yo"}), { id:"obj1"});
        assert.deepEqual(map2.get({"234ijdfapso#":"obj2", whatever:"yo"}), { id:"obj2"});
        assert.deepEqual(map2.get({"234ijdfapso#":"obj3", whatever:"yo"}), { id:"obj3"});
    });
});