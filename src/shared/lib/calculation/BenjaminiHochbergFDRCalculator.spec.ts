...
describe('#calculateQValue()', () => {
    ...
    it('returns correct q values for massive data', () => {
        ...
        const exampleResult = [
            0.017, 0.017, 0.017, 0.017, 0.017, 0.017, 0.017, 0.017, 0.017, 0.17,
            0.30909090909090914, 0.5666666666666668, 0.6538461538461539,
            0.7285714285714285, 0.7933333333333332, 0.8500000000000001, 0.9,
        ];
        assert.deepEqual(
            exampleResult,
            calculateQValues(arg),
