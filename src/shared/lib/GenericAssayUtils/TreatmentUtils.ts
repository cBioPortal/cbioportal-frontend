...
import { GenericAssayMetaFilter, GenericAssayDataFilter, GenericAssayData } from 'shared/api/generated/CBioPortalAPI';
    ...
    if (treatmentResponseProfiles.length > 0) {
        ...
        treatments = _.map(treatmentsMeta, (meta) => {
            return {
                ...
                name: "NAME" in meta.genericEntityMetaProperties ? meta.genericEntityMetaProperties["NAME"] : NOT_APPLICABLE_VALUE,
                description: "DESCRIPTION" in meta.genericEntityMetaProperties ? meta.genericEntityMetaProperties["DESCRIPTION"] : NOT_APPLICABLE_VALUE,
                refLink: "URL" in meta.genericEntityMetaProperties ? meta.genericEntityMetaProperties["URL"] : NOT_APPLICABLE_VALUE
            }
        })
    }
    return treatments;
