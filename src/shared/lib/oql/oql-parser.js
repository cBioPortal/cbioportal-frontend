        ...
        if (s0 === peg$FAILED) {
            ...
            if (s0 === peg$FAILED) {
                ...
                if (s0 === peg$FAILED) {
                    s0 = peg$currPos;
                    if (
                        input.substr(peg$currPos, 7).toLowerCase() === peg$c40
                    ) {
        ...
        if (s0 === peg$FAILED) {
            ...
            if (s0 === peg$FAILED) {
                ...
                if (s0 === peg$FAILED) {
                    s0 = peg$currPos;
                    if (
                        input.substr(peg$currPos, 8).toLowerCase() === peg$c129
                    ) {
                        s1 = input.substr(peg$currPos, 8);
                        peg$currPos += 8;
                    } else {
