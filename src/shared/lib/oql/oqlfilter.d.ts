...
export declare function filterCBioPortalWebServiceData<T>(oql_query:string, data:T[], accessors:any, default_oql:string, by_oql_line:string, mark_oql_regulation_direction:boolean): T[];