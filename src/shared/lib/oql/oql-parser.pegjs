...
Number
  ...
  / whole_part:NaturalNumber "." decimal_part:NaturalNumber {
...
StringExceptQuotes
  = stringExceptQuotes:[^"]+ { return stringExceptQuotes.join(""); }
...
MergedQuery
  ...
  / zmbs mergedGenes:StartMergedGenes qr:StandardQuery zmbs "]" {
      mergedGenes.list = qr;
      return [mergedGenes];
    }

StandardQuery
  = zmbs first:SingleGeneQuery ombs rest:StandardQuery {
      return [first].concat(rest);
    }
  / zmbs first:SingleGeneQuery { return [first]; }

SingleGeneQuery
  = geneName:String msp ":" msp alts:Alterations {
...
CNAType
  = AMP { return "AMP"; }
  / DEEPDEL { return "DEEPDEL"; }
  / GAIN { return "GAIN"; }
  / SHALLOWDEL { return "SHALLOWDEL"; }

CNACommand
  = "CNA"i msp op:ComparisonOp msp constrval:CNAType {
      return {
        alteration_type: "cna",
        constr_rel: op,
  ...
  / "CNA_" mod:CNAModifier {
      return { alteration_type: "cna", modifiers: [mod] };
    }
  / constrval:CNAType "_" mod:CNAModifier {
      return {
        alteration_type: "cna",
        constr_rel: "=",
        constr_val: constrval,
  ...
  / mod:CNAModifier "_CNA" {
      return { alteration_type: "cna", modifiers: [mod] };
    }
  / mod:CNAModifier "_" constrval:CNAType {
      return {
        alteration_type: "cna",
        constr_rel: "=",
        constr_val: constrval,
...
MUTCommand
  = MUT msp "=" msp mutation:MutationWithModifiers {
      return {
        alteration_type: "mut",
        constr_rel: "=",
...
EXPCommand
  = EXP msp op:ComparisonOp msp constrval:Number {
      return {
        alteration_type: "exp",
        constr_rel: op,
...
FUSIONCommand
  = "FUSION"i "_" mod:FusionModifier {
      return { alteration_type: "fusion", modifiers: [mod] };
    }
  / mod:FusionModifier "_FUSION"i {
      return { alteration_type: "fusion", modifiers: [mod] };
    }
  / "FUSION"i { return { alteration_type: "fusion", modifiers: [] }; }

PROTCommand
  = PROT msp op:ComparisonOp msp constrval:Number {
      return {
...
MutationWithModifiers
  ...
  = modifier:MutationModifier "_" mutationWithModifiers:MutationWithModifiers {
      mutationWithModifiers.modifiers.unshift(modifier);
      return mutationWithModifiers;
    }
  / mutation:Mutation "_" modifiers:MutationModifiers {
...
MutationModifiers
  = modifier:MutationModifier "_" more:MutationModifiers {
...
Mutation
  ...
  / letter:AminoAcid position:NaturalNumber string:MutationProteinChangeCode {
      return { type: "name", value: letter + position + string, info: {} };
    }
  / letter:AminoAcid position:NaturalNumber {
      return {
        type: "position",
  ...
  / mutation_name:MutationProteinChangeCode {
      return {
        type: "name",
        value: mutation_name,
...
MutationProteinChangeCode
  // the purpose of this is to disambiguate modifiers from parts of protein change codes, since both can look like this "_SOMETHING"
  = !TrailingMutationModifier
    firstChar:MutationProteinChangeCodeChar
    !TrailingMutationModifier
    rest:MutationProteinChangeCode { return firstChar + rest; } // dont start with "_MUTATIONMODIFIER" and dont look like "x_MUTATIONMODIFIER"
  / !TrailingMutationModifier lastChar:MutationProteinChangeCodeChar {
      return lastChar;
    } // dont start with "_MUTATIONMODIFIER"

TrailingMutationModifier = "_" mod:MutationModifier { return mod; }
...
DriverModifier = "DRIVER"i { return { type: "DRIVER" }; }

RangeModifier
  = "(" start:NaturalNumber "-" end:NaturalNumber e:[*]? ")" {
      return {
        type: "RANGE",
