...
> {
    public render() {
        ...
        const body = [getBrowserWindow().location.href]
            .concat(
                this.props.appStore.undismissedSiteErrors.map(
                    error => error.message
                )
            )
            .join('\n');
        ...
        return (
            <div className={'errorScreen'}>
                <a id="cbioportal-logo" href={buildCBioPortalPageUrl('/')}>
                    <img
                        src={require('./cbioportal_logo.png')}
                        alt="cBioPortal Logo"
                    />
                </a>
