...
import { DashboardPageStore } from 'pages/studyView/DashboardPageStore';
import {
...
export class StudyResultsSummary extends React.Component<
    { store: DashboardPageStore; appStore: AppStore; loadingComplete: boolean },
    {}
> {
    render() {
        return (
...
> {
    ...
    private store: DashboardPageStore;
    ...
    constructor(props: IStudyViewPageProps) {
        ...
        setWindowVariable('dashboardPageStore', this.store);
