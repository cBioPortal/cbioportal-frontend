...
> {
    ...
    get columnsWidth() {
        return {
            ...
            [ColumnKey.NUMBER_MUTATIONS]: correctColumnWidth(
            ...
            },
            {
                ...
                render: (data: MutationCountByGene) => (
                    <LabeledCheckbox
                        ...
                        onChange={event =>
                            this.togglePreSelectRow(data.entrezGeneId)
                        }
                        labelProps={{
                            style: {
                                display: 'flex',
    ...
    togglePreSelectRow(entrezGeneId: number) {
        let record:
            | MutatedGenesTableUserSelectionWithIndex
            | undefined = _.find(
            this.preSelectedRows,
            (row: MutatedGenesTableUserSelectionWithIndex) =>
                row.entrezGeneId === entrezGeneId
        ...
        if (_.isUndefined(record)) {
            ...
            let datum: MutationCountByGene | undefined = _.find(
                this.props.promise.result,
