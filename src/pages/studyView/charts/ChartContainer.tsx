...
import { PatientTreatmentsTableColumnKey, PatientTreatmentsTable } from '../table/treatments/PatientTreatmentsTable';
    ...
    get chart(): (() => JSX.Element) | null {        
        switch (this.chartType) {
            ...
            case ChartTypeEnum.SAMPLE_TREATMENTS_TABLE: {
                console.log("creating sample treatment table");
                ...
                return () => (
                    <SampleTreatmentsTable
                        ...
                        onUserSelection={this.handlers.onValueSelection}
                        columns={[
                            { columnKey: SampleTreatmentsTableColumnKey.TREATMENT },
            ...
            case ChartTypeEnum.PATIENT_TREATMENTS_TABLE: {
                ...
                return () => (
                    <PatientTreatmentsTable
                        ...
                        onUserSelection={this.handlers.onValueSelection}
                        columns={[
                            { columnKey: PatientTreatmentsTableColumnKey.TREATMENT },
                            { columnKey: PatientTreatmentsTableColumnKey.COUNT },
                        ]}
