...
export class StudyResultsSummary extends React.Component<
    { store: StudyViewPageStore; appStore: AppStore },
    {}
> {
    render() {
        return (
    ...
    constructor(props: IStudyViewPageProps) {
        ...
        this.queryReaction = reaction(
            ...
            query => {
                ...
                const newStudyViewFilter: StudyViewURLQuery = _.pick(
                    props.routing.location.query,
                    [
                        'id',
                        'studyId',
                        ...
                        <div>
                            ...
                            <div className={styles.mainTabs}>
                                <MSKTabs
                                    id="studyViewTabs"
                                    activeTabId={
                                        this.props.routing.location.query.tab
                                    }
                                ...
                                >
                                    ...
                                    >
                                        <IFrameLoader
                                            height={700}
                                            url={`//bioinformatics.mdanderson.org/TCGA/NGCHMPortal/?${
                                                this.store.MDACCHeatmapStudyMeta
                                                    .result[0]
                                            }`}
                                        />
                                            ...
                                            <DefaultTooltip
                                                ...
                                                overlay={() => (
                                                    <div
                                                        ...
                                                        onMouseEnter={() =>
                                                            (this.inCustomSelectTooltip = true)
                                                        }
                                                        onMouseLeave={() =>
                                                            (this.inCustomSelectTooltip = false)
                                                        }
                                                    >
                                                        <CustomCaseSelection
                                                            allSamples={
