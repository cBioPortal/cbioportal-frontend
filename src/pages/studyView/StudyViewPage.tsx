...
import { MappedColumnSpec } from '@cbioportal-cell-explorer/component';
...
> {
    ...
    //
    // Ports PR #5535's "Color by Consensus Signature" into this Option 4
    // Cell Explorer integration. Prototype scoping: only msk_spectrum_tme_2022
    // has the CONSENSUS_SIGNATURE attribute, and the zarr's donor_id obs
    // column is keyed on PATIENT_DISPLAY_NAME values.
