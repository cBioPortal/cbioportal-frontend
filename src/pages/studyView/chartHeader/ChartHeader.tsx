            ...
            >
                ...
                <If condition={this.active}>
                    <div className={classnames(styles.controls, 'controls')}>
                        <div
                            role="group"
                            className="btn-group logScaleCheckbox"
                        >
                            <If
                                condition={
                        ...
                        >
                            <DefaultTooltip
                                ...
                                align={tooltipAlign}
                                overlay={
                                    <span>Convert pie chart to table</span>
                                }
                            >
                                <i
                                    className={classnames(
                        ...
                        >
                            <DefaultTooltip
                                ...
                                align={tooltipAlign}
                                overlay={
                                    <span>Convert table to pie chart</span>
                                }
                            >
                                <i
                                    className={classnames(
