...
> {
    ...
    private wholeSlideViewerUrl = remoteData<string | undefined>({
        ...
        invoke: async () => {
            if (
                !_.isEmpty(patientViewPageStore.getWholeSlideViewerIds.result)
            ) {
    ...
    public render() {
        ...
        if (
                ...
                (sample: ClinicalDataBySampleId) => {
                    ...
                    return (
                        <div className="patientSample">
                            ...
                            {patientViewPageStore.hasMutationalSignatureData
                                .result === true && (
                                <LoadingIndicator
                                    isLoading={
                                        patientViewPageStore
                            ...
                            {patientViewPageStore.hasMutationalSignatureData
                                ...
                                patientViewPageStore.clinicalDataGroupedBySample
                                    .isComplete &&
                                patientViewPageStore.mutationalSignatureData
                                    .isComplete &&
                                patientViewPageStore.mutationalSignatureMetaData
                                    .isComplete && (
            ...
            if (
                ...
                patientViewPageStore.samples.result.length > 1
            ) {
                sampleHeader.push(
                    <button
                                ...
                                <MSKTab key={0} id="summary" linkText="Summary">
                                    ...
                                    <LoadingIndicator
                                        isLoading={
                                            ...
                                            patientViewPageStore
                                                ...
                                                .isPending ||
                                            patientViewPageStore.studyIdToStudy
                                                .isPending
                                        }
                                    />
                                    ...
                                    {patientViewPageStore.oncoKbAnnotatedGenes
                                        ...
                                        patientViewPageStore.studyIdToStudy
                                            ...
                                            <PatientViewMutationTable
                                                ...
                                                genomeNexusCache={
                                                    patientViewPageStore.genomeNexusCache
                                                }
                                    ...
                                    {patientViewPageStore.studyIdToStudy
                                        ...
                                        <CopyNumberTableWrapper
                                            ...
                                            gisticData={
                                                patientViewPageStore.gisticData
                                                    .result
                                            }
                                            mrnaExprRankMolecularProfileId={
                                                patientViewPageStore
