...
import { COLOR_GENEPANEL_ICON, genePanelIdToIconData, WHOLEGENOME_LABEL, sampleIdToIconData, COLOR_WHOLEGENOME_ICON, IKeyedIconData } from './GenomicOverviewUtils';
...
describe('GenomicOverviewUtils', () => {
    ...
    describe('genePanelIdToIconData()', () => {
        ...
        it('adds whole-genome icon data', () => {
            const genePanelIds = [GenePanelIdSpecialValue.WHOLE_EXOME_SEQ, GenePanelIdSpecialValue.WHOLE_GENOME_SEQ];
            
            const expectedData:any = {};
            expectedData[GenePanelIdSpecialValue.WHOLE_EXOME_SEQ] = {label: WHOLEGENOME_LABEL, color: COLOR_WHOLEGENOME_ICON, genePanelId: GenePanelIdSpecialValue.WHOLE_EXOME_SEQ};
            expectedData[GenePanelIdSpecialValue.WHOLE_GENOME_SEQ] = {label: WHOLEGENOME_LABEL, color: COLOR_WHOLEGENOME_ICON, genePanelId: GenePanelIdSpecialValue.WHOLE_GENOME_SEQ};
    ...
    describe('sampleIdToIconData()', () => {
        ...
        const iconLookUp = {
            panel1: {label: "P1", color: COLOR_GENEPANEL_ICON, genePanelId: 'panel1'},
            panel2: {label: "P2", color: COLOR_GENEPANEL_ICON, genePanelId: 'panel2'},
        };
        ...
        it('links undefined genePanelId to whole-genome analysis icon', () => {
            ...
            const expectedData = {
                ...
                sampleB: {label: "P1", color: COLOR_GENEPANEL_ICON, genePanelId: "panel1"}
            };
        ...
        it('links whole-genome genePanelIds to whole-genome analysis icon', () => {
            ...
            const myIconLookup:IKeyedIconData = { panel1: {label: "P1", color: COLOR_GENEPANEL_ICON, genePanelId: 'panel1'} };
            myIconLookup[GenePanelIdSpecialValue.WHOLE_EXOME_SEQ] = {label: WHOLEGENOME_LABEL, color: COLOR_WHOLEGENOME_ICON, genePanelId: GenePanelIdSpecialValue.WHOLE_EXOME_SEQ};
            myIconLookup[GenePanelIdSpecialValue.WHOLE_GENOME_SEQ] = {label: WHOLEGENOME_LABEL, color: COLOR_WHOLEGENOME_ICON, genePanelId: GenePanelIdSpecialValue.WHOLE_GENOME_SEQ};
            ...
            const expectedData = {
                sampleA: {label: WHOLEGENOME_LABEL, color: COLOR_WHOLEGENOME_ICON, genePanelId: GenePanelIdSpecialValue.WHOLE_EXOME_SEQ},
                sampleB: {label: WHOLEGENOME_LABEL, color: COLOR_WHOLEGENOME_ICON, genePanelId: GenePanelIdSpecialValue.WHOLE_GENOME_SEQ},
                sampleC: {label: "P1", color: COLOR_GENEPANEL_ICON, genePanelId: "panel1"}
            };
