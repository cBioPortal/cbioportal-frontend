...
const helpSection = (
    ...
    >
        ...
        <code>Type (defined below)</code>.<br />
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <code>UP</code>: expression up
                            </li>
                            <li>
                                <code>DOWN</code>: expression down
                            </li>
                        </ul>
                    </li>
                    <li>
...
> {
    ...
    private getHelpSection() {
        return (
            <div>
                <span>
                    Please input <strong>tab-delimited</strong> genomic
                    alteration events.
                </span>
                <Button
                    style={{ marginLeft: 7 }}
