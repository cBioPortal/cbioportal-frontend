...
export default class Tutorials extends React.Component<{}, {}> {
    ...
    public render() {
        ...
        return <PageLayout className={'whiteBackground staticPage'}>
            ...
            <hr />
            <h2 className={'tutorialsFolderText'}>View tutorial slides below or download from <a href="https://drive.google.com/drive/u/0/folders/0B9KTQJAGhFhhRi1qaTdUWmpLQTA">Google Drive</a> or <a href={`${AppConfig.serverConfig.skin_documentation_baseurl!.replace("raw.githubusercontent.com", "www.github.com").replace("/master/", "/tree/master/")}tutorials`}>GitHub</a>.</h2>
            <hr/>
            ...
            <h4><a href={`${AppConfig.serverConfig.skin_documentation_baseurl!}tutorials/cBioPortal Tutorial 1 Single Study Exploration.pdf`}>Download tutorial</a></h4>
            <hr/>
            ...
            <iframe
                ...
                frameBorder="0" width="720" height="434" allowFullScreen={true}></iframe>
            <h4><a href={`${AppConfig.serverConfig.skin_documentation_baseurl!}tutorials/cBioPortal Tutorial 2 Single Study Query.pdf`}>Download tutorial</a></h4>
            <hr/>
            ...
            <iframe src="https://docs.google.com/presentation/d/1Jr_2yEfgjKBn4DBiXRk4kmhIbtsRp6gd0iD3k1fIUUk/embed?start=false&loop=false&delayms=60000"
                frameBorder="0" width="720" height="434" allowFullScreen={true}></iframe>
            <h4><a href={`${AppConfig.serverConfig.skin_documentation_baseurl!}tutorials/cBioPortal Tutorial 3 Patient View.pdf`}>Download tutorial</a></h4>
            <hr/>
            ...
            <h4><a href={`${AppConfig.serverConfig.skin_documentation_baseurl!}tutorials/cBioPortal Tutorial 4 Virtual Studies.pdf`}>Download tutorial</a></h4>
            <hr />
            ...
            <iframe
                ...
                frameBorder="0" width="720" height="434"
                allowFullScreen={true}></iframe>
            <h4><a href={`${AppConfig.serverConfig.skin_documentation_baseurl!}tutorials/cBioPortal Tutorial 5 Onco Query Language.pdf`}>Download tutorial</a></h4>
            <hr />
            ...
            <iframe
                ...
                frameBorder="0" width="720" height="434"
                allowFullScreen={true}></iframe>
            <h4><a href={`${AppConfig.serverConfig.skin_documentation_baseurl!}tutorials/cBioPortal Tutorial 6 Group Comparison.pdf`}>Download tutorial</a></h4>
