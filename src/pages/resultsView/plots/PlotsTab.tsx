...
export default class PlotsTab extends React.Component<IPlotsTabProps, {}> {
    ...
    private initAxisMenuSelection(vertical: boolean): AxisMenuSelection {
        ...
        return observable({
            get entrezGeneId() {
                if (
                    this.dataType !== CLIN_ATTR_DATA_TYPE &&
                    this.selectedGeneOption
                ) {
                    if (
                        this.selectedGeneOption.value === SAME_GENE_OPTION_VALUE
                    ) {
            ...
            get selectedGeneOption() {
                ...
                if (
                    ...
                    this._selectedGeneOption.value === SAME_GENE_OPTION_VALUE &&
    ...
    @computed get vertGeneOptions() {
        ...
        if (
            ...
            this.horzSelection.dataType !== CLIN_ATTR_DATA_TYPE &&
            this.horzSelection.dataType !== GENESET_DATA_TYPE
        ) {
    ...
    @computed get vertGenesetOptions() {
        ...
        if (
            ...
            sameGenesetOption = [
                {
                    value: SAME_GENESET_OPTION_VALUE,
                    label: `Same gene set (${
                        this.horzSelection.selectedGenesetOption.label
                    })`,
                },
            ];
        }
    ...
    private swapHorzVertSelections() {
        ...
        if (
            ...
            this.vertSelection.selectedGeneOption.value.toString() !==
                SAME_GENE_OPTION_VALUE
        ) {
        ...
        if (
            ...
            this.vertSelection.selectedGenesetOption.value.toString() !==
                SAME_GENESET_OPTION_VALUE
        ) {
    ...
    readonly mutationPromise = remoteData({
        await: () =>
            this.props.store.putativeDriverAnnotatedMutationCache.getAll(
                getMutationQueries(this.horzSelection, this.vertSelection)
            ),
        invoke: () => {
            return Promise.resolve(
                _.flatten(
                    this.props.store.putativeDriverAnnotatedMutationCache
                        .getAll(
                            getMutationQueries(
                                this.horzSelection,
                                this.vertSelection
                    ...
                    (!!word.length &&
                        !!d.mutations.find(
                            m =>
                                !!(
                                    m.proteinChange &&
                                    m.proteinChange.indexOf(word) > -1
                                )
                        ));
                if (mutationMatch) {
                    break;
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            {dataSourceDescription && (
                                <InfoIcon
                                    tooltip={
                                        <span>{dataSourceDescription}</span>
                                    }
                        ...
                        <div className="form-group" style={{ opacity: 1 }}>
                            ...
                            <div style={{ display: 'flex' }}>
                                <ReactSelect
                                    ...
                                    options={
                                        this.horzGenesetOptions.isComplete
                                            ? vertical
        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    >
                        <i className="fa fa-arrow-up" /> Swap Axes{' '}
                        ...
                        if (this.scatterPlotData.isComplete) {
                            plotElt = (
                                <PlotsTabScatterPlot
                                    svgId={SVG_ID}
                                    axisLabelX={
                                        this.horzLabel.result! +
                                        this.horzLabelLogSuffix
                                    }
                                    axisLabelY={
                                        this.vertLabel.result! +
                                        this.vertLabelLogSuffix
                                    }
        ...
        return (
            <div data-test="PlotsTabEntireDiv">
                ...
                <div className={'plotsTab'} style={{ display: 'flex' }}>
                    ...
                    <div className="inlineBlock">{this.plot}</div>
                </div>
            </div>
        );
    }
