...
export enum ResultsViewURLQueryEnum {
    ...
    oncoprint_sort_ignore_passengers = 'oncoprint_sort_ignore_passengers',
...
const shouldForceRemount: { [prop in keyof ResultsViewURLQuery]: boolean } = {
    ...
    oncoprint_sort_ignore_passengers: false,
...
const propertiesMap = _.mapValues(
    {
        ...
        oncoprint_sort_ignore_passengers: { isSessionProp: false },
