...
export class ResultsViewPageStore {
    ...
    @computed get customDataFilterAppliers() {
        return {
            ...
            [MutationTableColumnType.NUM_MUTATIONS]: createNumericalFilter(
                (d: Mutation) =>
            ...
            [MutationTableColumnType.EXON]: createNumericalFilter(
                (d: Mutation) =>
                    ExonColumnFormatter.getSortValue([d], this.genomeNexusCache)
            ),
            ...
            [MutationTableColumnType.MUTATION_TYPE]: createCategoricalFilter(
                (d: Mutation) => MutationTypeColumnFormatter.getTextValue([d])
            ),
