...
import {
    ...
    Sample, CancerStudy, StructuralVariantFilter
...
import {
    ...
    getSampleAlteredMap, getSingleGeneResultKey, getMultipleGeneResultKey, getParamsForStructuralVariants,
...
describe("getParamsForStructuralVariants", ()=>{
    ...
    let selectedMolecularProfiles: MolecularProfile[] = [{
        ...
        studyId: 'STUDY1',
        study: {groups: '', name: 'STUDY1', publicStudy: true, shortName: 'STUDY1', status: 1, studyId: 'STUDY1'} as CancerStudy,
        name: 'PROFILE1',
        description: '',
    ...
    it('Returns empty Params if no data is present', () => {
        let result = getParamsForStructuralVariants(undefined, undefined, undefined);
    ...
    it('Returns expected params with Samples', () => {
        ...
        let expectedResult: StructuralVariantFilterExt = {entrezGeneIds:[0, 1, 2],
            sampleMolecularIdentifiers: [{molecularProfileId:'chol_nus_2012_structural_variants', sampleId:"B085"},
                {molecularProfileId: 'chol_nus_2012_structural_variants', sampleId: "B099"},
                {molecularProfileId: 'chol_nus_2012_structural_variants', sampleId: "R104"}]};
        assert.deepEqual(result, expectedResult as StructuralVariantFilter);
    });
    it('Returns expected params with MolecularProfiles', () => {
        let result = getParamsForStructuralVariants(genes, selectedMolecularProfiles, undefined);
        let expectedResult: StructuralVariantFilterExt = {entrezGeneIds:[0, 1, 2],
