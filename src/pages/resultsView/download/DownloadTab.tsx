...
> {
    ...
    readonly transposedMutationDownloadData = remoteData<string[][]>({
        ...
        invoke: () =>
            Promise.resolve(_.unzip(this.mutationDownloadData.result!)),
    });
    ...
    readonly mutationDataText = remoteData<string>({
        ...
        invoke: () =>
            Promise.resolve(
                stringify2DArray(this.mutationDownloadData.result!)
            ),
    });
    ...
    readonly transposedMrnaDataText = remoteData<string>({
        ...
        invoke: () =>
            Promise.resolve(
                stringify2DArray(this.transposedMrnaDownloadData.result!)
            ),
    });
    ...
    readonly transposedProteinDownloadData = remoteData<string[][]>({
        ...
        invoke: () =>
            Promise.resolve(_.unzip(this.proteinDownloadData.result!)),
    });
    ...
    readonly transposedCnaDataText = remoteData<string>({
        ...
        invoke: () =>
            Promise.resolve(
                stringify2DArray(this.transposedCnaDownloadData.result!)
            ),
    });
        ...
        invoke: () =>
            Promise.resolve(
                this.caseAlterationData
                    .result!.filter(caseAlteration => caseAlteration.altered)
                    .map(
                        caseAlteration =>
                            `${caseAlteration.studyId}:${
                                caseAlteration.sampleId
                            }`
                    )
            ),
    });
                ...
                return (
                    <WindowWidthBox data-test="downloadTabDiv" offset={60}>
                        ...
                        <div>
                            ...
                            />
                            {this.downloadableFilesTable.isComplete &&
                        ...
                        >
                            ...
                            />
                            {this.geneAlterationData.isComplete && (
                                <GeneAlterationTable
                                    geneAlterationData={
                        ...
                        <div className={styles['tables-container']}>
                            <FeatureTitle
                                ...
                                className="pull-left forceHeaderStyle h4"
                            />
                            {this.oqls.isComplete &&
                                this.caseAlterationData.isComplete &&
                                this.props.store
                                    .alterationsBySelectedMolecularProfiles
                                    .isComplete && (
                                    <CaseAlterationTable
                                        caseAlterationData={
    ...
    readonly alteredSamplesDownloadControls = remoteData({
        ...
        invoke: () => {
            ...
            return Promise.resolve(
                this.copyDownloadControlsRow(
                    'Samples affected: Only samples with an alteration are included',
                    handleDownload,
    ...
    readonly sampleMatrixDownloadControls = remoteData({
        ...
        invoke: () => {
            ...
            return Promise.resolve(
                this.copyDownloadControlsRow(
                    'Sample matrix: 1 = Sample harbors alteration in one of the input genes',
                    handleDownload,
                    'sample_matrix.txt'
                )
            );
