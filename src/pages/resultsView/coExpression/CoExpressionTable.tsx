...
const COLUMNS = [
    {
        ...
        render: (d: CoExpression) => (
            <span style={{ fontWeight: 'bold' }}>{d.hugoGeneSymbol}</span>
        ),
        filter: (d: CoExpression, f: string, filterStringUpper: string) =>
            d.hugoGeneSymbol.indexOf(filterStringUpper) > -1,
...
@observer
export default class CoExpressionTable extends React.Component<
    ICoExpressionTableProps,
    {}
> {
    @bind
