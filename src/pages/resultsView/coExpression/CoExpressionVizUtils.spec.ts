...
describe("CoExpressionVizUtils", ()=>{
    describe("computePlotData", ()=>{
        it("no data", ()=>{
            assert.deepEqual(computePlotData([], [], 0, 0, "", "", {} as any, {} as any), [], "empty empty empty");
            assert.deepEqual(
                computePlotData([], [{proteinChange:"G12D", uniqueSampleKey:"sample1", entrezGeneId:0}] as any, 0, 0, "", "", {} as any, {} as any),
                [],
        ...
        it("gene data with no mutations", ()=>{
            assert.deepEqual(
                ...
                ] as any, [], 0, 0, "gene0", "gene1", { samples: {}, patients: {} }, {} as any),
                [
        ...
        it("gene set data", ()=>{
            assert.deepEqual(
                ...
                ] as any, [], "abc", "abc", "def", "def", { samples: {}, patients: {} }, {} as any),
                [
