...
describe('MutualExclusivityUtil', () => {
    ...
    describe('#countOccurences()', () => {
        it('returns [1, 0, 0, 1] for [false, true] and [false, true]', () => {
            assert.deepEqual(countOccurences([false, true], [false, true]), [
                1,
                0,
                0,
                1,
        ...
        it('returns [2, 0, 0, 0] for [false, false] and [false, false]', () => {
            assert.deepEqual(countOccurences([false, false], [false, false]), [
                2,
                0,
                0,
                0,
        ...
        it('returns rows correctly', () => {
            ...
            assert.equal(
                cells
                    ...
                    .html()
                    .replace(/<!--[^>]*-->/g, ''),
                '<td><div class="styles-module__Tendency__2Y46X">' +
