...
export default class ResultViewFusionMapper extends React.Component<IFusionMapperProps, {}> {
    ...
    private renderComponents() {
        const {
            dataStore, fusionCounts, exonsChartStore, fusionMolecularProfile,
            studyIdToStudy, molecularProfileIdToMolecularProfile
        } = this.props.store;

        const studyMap = new Map(Object.entries(studyIdToStudy.result || {}));
        const molecularProfileMap = new Map(Object.entries(molecularProfileIdToMolecularProfile.result || {}));

        return (
            <React.Fragment>
                <div style={{display: 'flex', flexWrap: 'wrap'}}>
                    <ExonsChart store={this.props.store.exonsChartStore}/>
                    <FusionPieChart store={dataStore} fusionCounts={fusionCounts}/>
