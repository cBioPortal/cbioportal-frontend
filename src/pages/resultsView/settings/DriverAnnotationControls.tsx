...
export interface IDriverAnnotationControlsHandlers {
    ...
    onCustomDriverTierCheckboxClick?:(event:React.MouseEvent<HTMLInputElement>)=>void;
}
...
@observer
export default class DriverAnnotationControls extends React.Component<IDriverAnnotationControlsProps, {}> {
        ...
        return (
            <div>
                ...
                <div style={{marginLeft: "20px"}}>
                    ...
                    {this.props.handlers.onCustomDriverTierCheckboxClick && !!this.props.state.customDriverAnnotationTiersMenuLabel && (
                        <span>
                                ...
                                {(this.props.state.customDriverAnnotationTiers || []).map((tier)=>(
                                    <div className="checkbox"><label>
                                        <input
                                            ...
                                            onClick={this.props.handlers.onCustomDriverTierCheckboxClick}
                                        /> {tier}
                                    </label></div>
                                ))
                                }
