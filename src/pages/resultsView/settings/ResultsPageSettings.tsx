...
export default class ResultsPageSettings extends React.Component<IResultsPageSettingsProps, {}> {
    ...
    render() {
        return (
            <div id="globalSettingsDropdown" className="cbioportal-frontend" style={{padding:5}}>
                <h5>Data Type</h5>
                <InfoIcon style={{color:"rgb(54, 134, 194)"}} tooltip={<span>This setting affects the following tabs: {boldedTabList(["Oncoprint"])}</span>}/>
                ...
                <h5>Annotate Data</h5>
                <InfoIcon style={{color:"rgb(54, 134, 194)"}} tooltip={
