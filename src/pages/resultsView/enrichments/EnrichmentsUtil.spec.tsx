...
describe('EnrichmentsUtil', () => {
    ...
    describe('#getAlterationScatterData()', () => {
        ...
        it('returns correct scatter data', () => {
            assert.deepEqual(
                getAlterationScatterData(exampleAlterationEnrichmentRowData, [
                    'EGFR',
                ]),
                [
                    {
    ...
    describe('#getAlterationRowData()', () => {
        ...
        it('returns correct row data', () => {
            assert.deepEqual(
                getAlterationRowData(exampleAlterationEnrichments, 4, 84, [
                    'EGFR',
                ]),
    ...
    describe('#getExpressionRowData()', () => {
        ...
        it('returns correct row data', () => {
            assert.deepEqual(
                getExpressionRowData(exampleExpressionEnrichments, ['EGFR']),
