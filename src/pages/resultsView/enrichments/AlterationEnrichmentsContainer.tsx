...
> {
    ...
    @computed get data(): AlterationEnrichmentRow[] {
        return getAlterationRowData(
            this.props.data,
            this.props.totalAlteredCount,
            this.props.totalUnalteredCount,
    ...
    @computed get clickedGeneStats(): [number, number, number, number] {
        const clickedAlterationEnrichment: AlterationEnrichment = _.find(
            this.props.data,
            ['hugoGeneSymbol', this.clickedGene]
        )!;
            ...
            <div className={styles.Container}>
                <div className={styles.LeftColumn}>
                    {this.chartType === ChartType.VOLCANO && (
                        <MiniScatterChart
                            ...
                            xAxisLeftLabel="Mutual exclusivity"
                            xAxisRightLabel="Co-occurrence"
                            xAxisDomain={15}
                    ...
                    {this.chartType === ChartType.FREQUENCY && (
                        <MiniFrequencyScatterChart
                            ...
                            xGroupName={'Altered Tumors'}
                            yGroupName={'Unaltered Tumors'}
                            onGeneNameClick={this.onGeneNameClick}
                            onSelection={this.onSelection}
                            onSelectionCleared={this.onSelectionCleared}
                        />
                    ...
                    <MiniBarChart
                        totalAlteredCount={this.props.totalAlteredCount}
                        totalUnalteredCount={this.props.totalUnalteredCount}
                        selectedGene={this.clickedGene}
                        selectedGeneStats={
                            this.clickedGene ? this.clickedGeneStats : null
                        }
                    />
                </div>
                <div className={styles.TableContainer}>
                    ...
                    <AlterationEnrichmentTable
                        ...
                        onCheckGene={this.onCheckGene}
                        onGeneNameClick={this.onGeneNameClick}
                        alterationType={this.props.alterationType}
