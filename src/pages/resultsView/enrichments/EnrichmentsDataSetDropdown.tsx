...
> {
    ...
    private change(o: any) {
        ...
        this.props.onChange(
            this.props.dataSets.result!.find(
                d => d.molecularProfileId === o.value
            )!
        );
    }
    ...
    public render() {
        if (
            this.props.dataSets.isComplete &&
            this.props.dataSets.result!.length === 1 &&
            (this.props.dataSets.result![0].molecularAlterationType ===
                'MUTATION_EXTENDED' ||
                this.props.dataSets.result![0].molecularAlterationType ===
