...
export default class ExpressionEnrichmentTable extends React.Component<IExpressionEnrichmentTableProps, {}> {
    ...
    @computed get columns(): { [columnEnum: string]: ExpressionEnrichmentTableColumn } {
        const columns: { [columnEnum: string]: ExpressionEnrichmentTableColumn } = this.props.customColumns || {};
