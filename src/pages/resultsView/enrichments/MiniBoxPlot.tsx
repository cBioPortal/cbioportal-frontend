...
> {
    ...
    public render() {
        const molecularProfileId = this.props.selectedProfile
            .molecularProfileId;
            ...
            <div>
                {this.props.selectedGeneHugo && this.scatterData.length > 0 && (
                    <div>
                        ...
                        >
                            Boxplots of {this.props.selectedProfile.name} data
                            for altered and unaltered cases
                        </div>
                        <div className="posRelative">
                            ...
                            >
                                ...
                                >
                                    <VictoryAxis
                                        tickValues={[1, 2]}
                                        tickFormat={(t: any) =>
                                            t === 1 ? 'Altered' : 'Unaltered'
                                        }
                                        label={
                                            'Query: ' +
                                            shortenGenesLabel(
                                                this.props.queryGenes,
                                                2
                                            ) +
                                            '\n(q-Value: ' +
                            ...
                            {this.tooltipModel && (
                                ...
                                >
                                    ...
                                    <br />
                                    mRNA expression:{' '}
                                    {this.tooltipModel.datum.y.toFixed(3)}
                                    <br />
                                    Alteration(s):{' '}
                                    {this.tooltipModel.datum.alterations}
                                </Popover>
                            )}
                        </div>
                    </div>
