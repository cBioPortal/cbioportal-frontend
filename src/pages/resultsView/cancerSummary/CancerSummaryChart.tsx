...
> {
    ...
    buildTooltip(tooltipModel: ITooltipModel) {
        return (
            <div
                className="popover cbioTooltip right"
                    ...
                    <p>
                        ...
                        {percentageRounder(
                            tooltipModel.alterationData.alteredSampleCount /
                                tooltipModel.alterationData.sampleTotal
                        )}
                        % of {tooltipModel.alterationData.sampleTotal} cases
                    </p>
        ...
        return (
            <div data-test="cancerTypeSummaryChart">
                <div style={this.overflowStyle} className="borderedChart">
                    <div
                        ref={(el: HTMLDivElement) => (this.scrollPane = el)}
