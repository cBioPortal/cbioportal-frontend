 ...
 */
export default function DataManagerPresenter(dmInitCallBack)
{
    ...
    this.getAlterationEvents = function(cancerType, cancerTypeDetailed, geneId) {
        ...
        if (cancerTypeDetailed === null)
            sampleIds = this.cancerTypeList[cancerType].sampleIds;
        else
    ...
    this.getTotalNrSamplesPerCancerType = function(cancerType, cancerTypeDetailed) {
        if (cancerTypeDetailed == null)
            return this.cancerTypeList[cancerType].sampleIds.length;
        else
            return this.cancerTypeList[cancerType].cancerTypeDetailed[cancerTypeDetailed].sampleIds.length;
    }
