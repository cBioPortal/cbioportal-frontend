...
describe("rectangleVennDiagram/geometry", () => {
    ...
    describe("getRegionArea", ()=>{
        ...
        it("A and B", ()=>{
            const shape = getRegionShape(["a","b"], {a:setRectangles.a, b:setRectangles.b});
            assert.equal(getRegionArea(shape), 40);
        });
        it("A not B", ()=>{
            const shape = getRegionShape(["a"], {a:setRectangles.a, b:setRectangles.b});
