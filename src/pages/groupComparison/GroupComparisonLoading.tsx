            ...
            return (
                <div style={{
                    ...
                    <div className="alert alert-error">
                        <i className="fa fa-md fa-exclamation-triangle" style={{marginRight:7}}/>
                        Sorry - please don't close the Study Summary window until the comparison page has finished loading.
                        <br/>
                        <br/>
                        <a href={getStudySummaryUrl(query.origin!.split(","))}>Back to Study Summary</a>
                    </div>
                </div>
            );
        } else {
