...
async function installFoundationMocks(page: Page): Promise<string[]> {
    ...
    // The combined stack can start optional molecular hydration while the
    // foundation bundle must not. Keep that optional request harmless when
    // this contract is run against a child that includes molecular code.
