...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT =
    ...
    {
        13469: (e, t, i) => {
            i.r(t), i.d(t, { MathJaxTypesetter: () => n });
            var a = i(26169);
            class n {
                constructor(e) {
                    (this._initPromise = new a.PromiseDelegate()),
                        (this._initialized = !1),
                        (this._url = e.url),
                    ...
                    this._initialized || this._init(),
                        this._initPromise.promise.then(() => {
                            ...
                            try {
                                ...
                                console.error(
                                    'Error queueing resetEquationNumbers:',
                                    e
                                );
                            }
                        });
                ...
                _init() {
                    ...
                    (t.type = 'text/javascript'),
                        (t.src = `${this._url}?config=${this._config}&amp;delayStartupUntil=configured`),
                        (t.charset = 'utf-8'),
                        e.appendChild(t),
                ...
                _onLoad() {
                    MathJax.Hub.Config({
                        ...
                        displayAlign: 'center',
                        CommonHTML: { linebreaks: { automatic: !0 } },
                        'HTML-CSS': {
                            availableFonts: [],
                            imageFont: null,
                            preferredFont: null,
