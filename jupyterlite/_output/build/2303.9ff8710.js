...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT =
    ...
    [2303],
    {
        33468: (o, r, e) => {
            ...
            a.push([
                ...
                '',
                {
                    version: 3,
                    sources: [
                        'webpack://./../node_modules/codemirror/theme/mbo.css',
                    ],
                    names: [],
                    mappings:
        ...
        1892: o => {
            ...
            function c(o, c) {
                for (var t = {}, a = [], m = 0; m < o.length; m++) {
                    var s = o[m],
                        A = c.base ? s[0] + c.base : s[0],
                        i = t[A] || 0,
                        l = ''.concat(A, ' ').concat(i);
                    t[A] = i + 1;
                    var f = e(l),
                    ...
                    if (-1 !== f) r[f].references++, r[f].updater(b);
                    else {
                        var d = n(b, c);
                        (c.byIndex = m),
                            r.splice(m, 0, {
            ...
            o.exports = function(o, n) {
                ...
                return function(o) {
                    ...
                    for (var s = c(o, n), A = 0; A < t.length; A++) {
                        var i = e(t[A]);
                        0 === r[i].references &&
                ...
                return {
                    update: function(e) {
                        !(function(o, r, e) {
                            var c = '';
                            e.supports &&
                                (c += '@supports ('.concat(e.supports, ') {')),
                                e.media &&
                                    (c += '@media '.concat(e.media, ' {'));
                            ...
                            t &&
                                ...
                                r.styleTagTransform(c, o, r.options);
                        })(r, o, e);
                    },
                    remove: function() {
                        !(function(o) {
