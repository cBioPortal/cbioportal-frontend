...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT =
    ...
    [2161],
    {
        54695: (e, t, n) => {
            ...
            for (const e of i)
                for (const t of ['-webkit-', '-ms-', '-moz-', '-o-', ''])
                    s[t + e] = !0;
            function o(e, t) {
                return t && 'number' == typeof t && !s[e]
                    ? `${e}:${t}px`
                    : `${e}:${t}`;
            }
            function a(e) {
            ...
            function l(e, t, n, r, s) {
                const { style: i, nested: o, isUnique: u } = (function(e, t) {
                    const n = [],
                        r = [];
                ...
                if (64 === e.charCodeAt(0)) {
                    ...
                    for (const [e, n] of o)
                        d += e + l(e, n, t.rules, t.styles, s);
                } else {
                    const t = s ? c(e, s) : e;
                    i && r.push({ selector: t, style: i, isUnique: u });
                    for (const [e, s] of o) d += e + l(e, s, n, r, t);
                }
                return d;
            }
            function u(e, t, n, s, i, o) {
                for (const { selector: n, style: a, isUnique: h } of s) {
                    const s = o ? c(n, i) : n,
                        l = h ? `u\0${(++r).toString(36)}` : `s\0${t}\0${a}`,
                        u = new p(a, l);
                    u.add(new y(s, `k\0${t}\0${s}`)), e.add(u);
                }
                for (const {
                    selector: r,
                    style: s,
                    ...
                    const n = new m(r, s, `r\0${t}\0${r}\0${s}`);
            ...
            class v extends g {
                ...
                registerHashRule(e, t) {
                    const n = [],
                        ...
                        s = l('', t, n, r),
                        i = _(s),
                        o = new m(`${e} ${i}`, '', `h\0${s}\0${e}`);
                    return u(o, s, n, r, '', !1), this.add(o), i;
                }
                registerRule(e, t) {
                    const n = [],
                        r = [];
                    u(this, l(e, t, n, r), n, r, '', !1);
                }
                registerCss(e) {
            ...
            function S(e) {
                return new v(`f${(++r).toString(36)}`, e);
            }
        },
        82161: (e, t, n) => {
            var r = n(23476);
            r.TypeStyle, n(14651);
            var s = n(84086);
            s.extend, (t.Sh = s.classes), s.media;
            var i = new r.TypeStyle({ autoGenerateTag: !0 });
            i.setStylesTarget,
                i.cssRaw,
                i.cssRule,
                i.forceRenderStyles,
                        ...
                        (this.cssRaw = function(e) {
                            ...
                            (this.cssRule = function(e) {
                                for (
                                    ...
                                    n[r - 1] = arguments[r];
                                var o = s.convertToStyles(
                                    i.extend.apply(void 0, n)
                                );
                            ...
                            (this.getStyles = function() {
                                return (
                                    (t._raw || '') + t._freeStyle.getStyles()
                                );
                            }),
                            (this.keyframes = function(e) {
                                var n = s.convertToKeyframes(e),
                                    r = t._freeStyle.registerKeyframes(n);
                                return t._styleUpdated(), r;
                            }),
                    ...
                    return (
                        ...
                        (e.prototype.style = function() {
                            var e = this._freeStyle.registerStyle(
                                s.convertToStyles(
                                    i.extend.apply(void 0, arguments)
                                )
                            );
        ...
        84086: (e, t) => {
            function n() {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                for (var r = {}, s = 0, i = e; s < i.length; s++) {
                    var o = i[s];
                    if (null != o && !1 !== o)
                        for (var a in o) {
                            var h = o[a];
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                ...
                (t.extend = n),
                (t.media = function(e) {
                    for (var t, s = [], i = 1; i < arguments.length; i++)
                        s[i - 1] = arguments[i];
                    var o = [];
                    e.type && o.push(e.type),
                        ...
                        e.minWidth &&
                            o.push('(min-width: ' + r(e.minWidth) + ')'),
                        e.maxWidth &&
                            o.push('(max-width: ' + r(e.maxWidth) + ')'),
                        e.minHeight &&
                            o.push('(min-height: ' + r(e.minHeight) + ')'),
                        e.maxHeight &&
...
//# sourceMappingURL=2161.dcb27b8.js.map
