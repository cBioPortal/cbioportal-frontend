        ...
        46827: (n, r, o) => {
            ...
            A.push([
                ...
                '',
                {
                    version: 3,
                    sources: [
                        'webpack://./../node_modules/codemirror/theme/nord.css',
                    ],
                    names: [],
                    mappings:
        ...
        1892: n => {
            ...
            function c(n, c) {
                for (var t = {}, A = [], s = 0; s < n.length; s++) {
                    ...
                    if (-1 !== l) r[l].references++, r[l].updater(p);
                    else {
                        var u = e(p, c);
                        (c.byIndex = s),
                            r.splice(s, 0, {
            ...
            n.exports = function(n, e) {
                ...
                return function(n) {
                    ...
                    for (var a = c(n, e), d = 0; d < t.length; d++) {
                        var i = o(t[d]);
                        0 === r[i].references &&
