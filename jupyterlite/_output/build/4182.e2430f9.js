...
(self.webpackChunk_JUPYTERLAB_CORE_OUTPUT =
    ...
    [4182],
    {
        39289: (n, e, r) => {
            ...
            c.push([
                ...
                '',
                {
                    version: 3,
                    sources: [
                        'webpack://./../node_modules/codemirror/theme/material-palenight.css',
                    ],
                    names: [],
                    mappings:
        ...
        1892: n => {
            ...
            function a(n, a) {
                for (var o = {}, c = [], i = 0; i < n.length; i++) {
                    var l = n[i],
                        A = a.base ? l[0] + a.base : l[0],
                        m = o[A] || 0,
                        s = ''.concat(A, ' ').concat(m);
                    o[A] = m + 1;
                    var p = r(s),
            ...
            n.exports = function(n, t) {
                ...
                return function(n) {
                    ...
                    for (var l = a(n, t), A = 0; A < o.length; A++) {
                        var m = r(o[A]);
                        0 === e[m].references &&
...
//# sourceMappingURL=4182.e2430f9.js.map
