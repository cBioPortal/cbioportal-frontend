    ...
    [6571],
    {
        ...
        96571: (e, t, r) => {
            ...
            const f = [],
                ...
                g = e => {
                    return void 0 ===
                        (t = u ? {}[e.toUpperCase()] : s.X.getItem(e))
                        ? null
                        : t;
                    var t;
                };
            d('--' + 'production') || g('production');
            const y = u && i.gB({}.FORCE_COLOR, ['true', '1', '2']),
                m =
                    !d('no-colors') &&
                    (!u || c.stdout.isTTY || y) &&
                    (!u ||
                    ...
                    switch (e.constructor) {
                        ...
                        case Map:
                            ...
                            for (const r of e.keys())
                                if (!t.has(r) || !c(e.get(r), t.get(r)))
                                    return !1;
                            break;
                        case Object:
                            if (o.kE(e) !== o.kE(t)) return !1;
                            for (const r in e)
                                if (!o.l$(e, r) || !c(e[r], t[r])) return !1;
                            break;
                        case Array:
        ...
        31234: (e, t, r) => {
            ...
            const n = () => new Map(),
                ...
                i = (e, t) => {
                    const r = [];
                    for (const [n, o] of e) r.push(t(o, n));
                    return r;
                },
                c = (e, t) => {
        ...
        99622: (e, t, r) => {
            ...
            const s = n,
                i = e => o || addEventListener('storage', e);
        },
        1011: (e, t, r) => {
            'use strict';
            r.d(t, {
            ...
            const n = String.fromCharCode,
                o = (String.fromCodePoint, /^\s*/g),
                s = /([A-Z])/g,
                i = (e, t) =>
                    (e => e.replace(o, ''))(
                        e.replace(s, e => `${t}${(e => e.toLowerCase())(e)}`)
                    ),
                c =
                ...
                u = c
                    ...
                    : e => {
                          const t = unescape(encodeURIComponent(e)),
                              r = t.length,
                              n = new Uint8Array(r);
                          for (let e = 0; e < r; e++) n[e] = t.codePointAt(e);
                          return n;
                      };
            let l =
            ...
            (n.nextTick = function(e) {
                ...
                if (arguments.length > 1)
                    for (var r = 1; r < arguments.length; r++)
                        t[r - 1] = arguments[r];
                u.push(new d(e, t)), 1 !== u.length || l || i(h);
            }),
