        ...
        84288: (e, t, s) => {
            ...
            function p(e, t = self) {
                t.addEventListener('message', function s(i) {
                    ...
                    const { id: n, type: o, path: l } = Object.assign(
                        ...
                        u = (i.data.argumentList || []).map(b);
                    let h;
                    try {
                        const t = l.slice(0, -1).reduce((e, t) => e[t], e),
                            s = l.reduce((e, t) => e[t], e);
                        switch (o) {
                            case 'GET':
                                h = s;
                                break;
                            case 'SET':
                                (t[l.slice(-1)[0]] = b(i.data.value)), (h = !0);
                                break;
                            case 'APPLY':
                                h = s.apply(t, u);
                                break;
                    ...
                    Promise.resolve(h)
                        ...
                        .then(e => {
                            const [a, i] = y(e);
                            t.postMessage(
                                Object.assign(Object.assign({}, a), { id: n }),
                                i
                            ),
                                'RELEASE' === o &&
                                    (t.removeEventListener('message', s), c(t));
                        });
                }),
                    t.start && t.start();
            }
            ...
            function d(e, t = [], s = function() {}) {
                ...
                const r = new Proxy(s, {
                    ...
                    apply(s, n, r) {
                        ...
                        if (o === i) return f(e, { type: 'ENDPOINT' }).then(b);
                        if ('bind' === o) return d(e, t.slice(0, -1));
                        const [l, p] = m(r);
                        return f(
                            e,
                            {
            ...
            function m(e) {
                ...
                return [
                    t.map(e => e[0]),
                    ((s = t.map(e => e[1])),
                    Array.prototype.concat.apply([], s)),
                ];
                var s;
            }
            const _ = new WeakMap();
            function y(e) {
                for (const [t, s] of l)
                    if (s.canHandle(e)) {
                        const [a, i] = s.serialize(e);
                        return [{ type: 'HANDLER', name: t, value: a }, i];
                    }
                return [{ type: 'RAW', value: e }, _.get(e) || []];
            }
            function b(e) {
                switch (e.type) {
                    case 'HANDLER':
            ...
            function f(e, t, s) {
                return new Promise(a => {
                    const i = new Array(4)
                        ...
                        .join('-');
                    e.addEventListener('message', function t(s) {
                        s.data &&
                            s.data.id &&
                            s.data.id === i &&
                            (e.removeEventListener('message', t), a(s.data));
                    }),
                        e.start && e.start(),
                        e.postMessage(Object.assign({ id: i }, t), s);
                });
            }
        },
        56206: (e, t, s) => {
            s.r(t),
                s.d(t, {
                    PIPLITE_WHEEL: () => _,
                    PyoliteKernel: () => g,
                    PyoliteRemoteKernel: () => k,
                    allJSONUrl: () => i,
                    ipykernelWheelUrl: () => r,
                    pipliteWheelUrl: () => l,
                    pyoliteWheelUrl: () => c,
                    widgetsnbextensionWheelUrl: () => h,
                    widgetsnbextensionWheelUrl1: () => m,
                });
            const a = s.p + 'all.json';
            var i = s.t(a);
            const n = s.p + 'ipykernel-6.9.2-py3-none-any.whl';
            var r = s.t(n);
            const o = s.p + 'piplite-0.1.0b18-py3-none-any.whl';
            var l = s.t(o);
            const p = s.p + 'pyolite-0.1.0b18-py3-none-any.whl';
            var c = s.t(p);
            const u = s.p + 'widgetsnbextension-3.6.0-py3-none-any.whl';
            var h = s.t(u);
            const d = s.p + 'widgetsnbextension-4.0.2-py3-none-any.whl';
            var m = s.t(d);
            const _ = 'piplite-0.1.0b18-py3-none-any.whl';
            var y = s(26169),
                b = s(96801),
                f = s(56255),
                w = s(84288);
            class g extends f.BaseKernel {
                constructor(e) {
                    super(e),
                        ...
                        (this._remoteKernel = (0, w.Ud)(this._worker)),
                        this.initRemote(e);
                }
                initWorker(e) {
                    return new Worker(new URL(s.p + s.u(6662), s.b), {
                        type: void 0,
                    });
                }
                async initRemote(e) {
                    const t = this.initRemoteOptions(e);
                    await this._remoteKernel.initialize(t),
                        this._ready.resolve();
                }
                initRemoteOptions(e) {
                    const { pyodideUrl: t } = e,
                        s = t.slice(0, t.lastIndexOf('/') + 1),
                        a = b.PageConfig.getBaseUrl(),
                        i = b.URLExt.join(a, 'build/pypi'),
                        n = [
                            ...(e.pipliteUrls || []),
                            b.URLExt.join(i, 'all.json'),
                        ];
                    return {
                        baseUrl: a,
                        pyodideUrl: t,
                        indexUrl: s,
                        pipliteWheelUrl: b.URLExt.join(i, _),
                        pipliteUrls: n,
                        disablePyPIFallback: !!e.disablePyPIFallback,
            ...
            class k {
                constructor() {
                    (this._options = null),
                        ...
                        (this._initialized = new Promise((e, t) => {
                            this._initializer = { resolve: e, reject: t };
                        }));
                }
                async initialize(e) {
                    var t;
                    if (((this._options = e), e.location.includes(':'))) {
                        const t = e.location.split(':');
                        (this._driveName = t[0]), (this._localPath = t[1]);
                    } else
                        (this._driveName = ''), (this._localPath = e.location);
                ...
                async initGlobals(e) {
                    ...
                    (this._kernel = t.get('pyolite').kernel_instance.copy()),
                ...
                async initFilesystem(e) {
                    if (e.mountDrive) {
                        const t = '/drive',
                            { FS: a, PATH: i, ERRNO_CODES: n } = this._pyodide,
                            { baseUrl: r } = e,
                            { DriveFS: o } = await s
                                .e(4281)
                                .then(s.t.bind(s, 54281, 23)),
                            l = new o({
                                FS: a,
                                PATH: i,
                                ERRNO_CODES: n,
                ...
                async setup(e) {
                    await this._initialized,
                        (this._kernel._parent_header = this._pyodide.toPy(e));
                }
                async execute(e, t) {
                    await this.setup(t);
                    const s = (e, t) => {
                    ...
                    (this._stdout_stream.publish_stream_callback = s),
                        (this._stderr_stream.publish_stream_callback = s),
                    ...
                    return (
                        'error' === i.status &&
                            ((e, t, s) => {
                                const a = { ename: e, evalue: t, traceback: s };
                                postMessage({
                                    parentHeader: this.formatResult(
                                        this._kernel._parent_header
                                    ).header,
                ...
                async complete(e, t) {
                    await this.setup(t);
                    const s = this._kernel.complete(e.code, e.cursor_pos);
                    return this.formatResult(s);
                }
                async inspect(e, t) {
                    await this.setup(t);
                    const s = this._kernel.inspect(
                        e.code,
                        e.cursor_pos,
                        e.detail_level
                    );
                ...
                async isComplete(e, t) {
                    await this.setup(t);
                    const s = this._kernel.is_complete(e.code);
                    return this.formatResult(s);
                }
                async commInfo(e, t) {
                    await this.setup(t);
                    const s = this._kernel.comm_info(e.target_name);
                    return this.formatResult(s);
                }
                async commOpen(e, t) {
                    await this.setup(t);
                    const s = this._kernel.comm_manager.comm_open(
                ...
                async commMsg(e, t) {
                    await this.setup(t);
                    const s = this._kernel.comm_manager.comm_msg(
                        this._pyodide.toPy(e)
                    );
                    return this.formatResult(s);
                }
                async commClose(e, t) {
                    await this.setup(t);
                    const s = this._kernel.comm_manager.comm_close(
                        this._pyodide.toPy(e)
                    );
                    return this.formatResult(s);
                }
